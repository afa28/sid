			...
			<div class="box-header with-border">
				<?php if ($detail["status"] == 1): ?>
					...
					<div class="btn-group btn-group-vertical">
						...
						<ul class="dropdown-menu" role="menu">
							<li>
								<a href="<?= site_url("program_bantuan/export/$detail[id]"); ?>" class="btn btn-social btn-flat btn-block btn-sm" title="Import"><i class="fa fa-upload"></i> Import</a>
							</li>
							<li>
								<a href="<?= site_url("program_bantuan/export/$detail[id]"); ?>" class="btn btn-social btn-flat btn-block btn-sm" title="Export"><i class="fa fa-download"></i> Export</a>
							</li>
						</ul>
					</div>
				<?php endif; ?>
