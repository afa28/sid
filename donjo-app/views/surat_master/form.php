...
<script>
	...
	function reset_form() {
		...
		<?php endif; ?>
		<?php if ($surat_master['mandiri'] == '0' OR $surat_master['mandiri'] == null): ?>
			$("#m2").addClass('active');
				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="btn-group col-xs-12 col-sm-8" data-toggle="buttons">
							...
							<label id="m2" class="tipe btn btn-info btn-flat btn-sm col-xs-12 col-sm-6 col-lg-2 form-check-label <?= jecho($surat_master['mandiri'] == 0 OR $surat_master['mandiri'] == NULL, TRUE, 'active'); ?>">
								<input id="g2" type="radio" name="mandiri" class="form-check-input" type="radio" value="0" <?= jecho($surat_master['mandiri'] == 0 OR $surat_master['mandiri'] == NULL, TRUE, 'checked'); ?> autocomplete="off">Tidak
							</label>
						</div>
					</div>
