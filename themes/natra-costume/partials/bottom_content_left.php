...
<div class="content_bottom_left" style="margin-bottom:10px;">
												...
												<li>
														<div class="catgimg2_container2">
																<h5 class="catg_titile">
																		<a href="<?= site_url(buat_slug($headline)); ?>"> <?= $headline['judul'] ?></a>
																</h5>
																<a href="<?= site_url(buat_slug($headline)); ?>">
		...
		<?php $title = (!empty($judul_kategori))? $judul_kategori : "Berita Terbaru" ?>
						...
						<div class="business_category_left wow fadeInDown">
								<ul class="fashion_catgnav">
										<li>
												<div class="catgimg2_container2">
														<h5 class="catg_titile">
																<a href="<?= site_url(buat_slug($data)); ?>" title="Baca Selengkapnya"><?= $data["judul"] ?></a>
														</h5>
														...
														<a href="<?= site_url(buat_slug($data)); ?>" title="Baca Selengkapnya" style="font-weight:bold">
