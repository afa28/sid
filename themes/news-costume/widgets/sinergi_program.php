...
<div id="sinergi_program" class="widget-sinergi_program">
    <table>
        ...
        <tr>
            <td>
                ...
                <?php
                	$_SINERGI_PROGRAM[] = $program;
                ?>
                <span style="display: inline-block; width: <?php echo $width.'%'?>">
                    <a href="<?php echo $program['tautan']?>" target="_blank"><img
                            src="<?php echo base_url()?>desa/upload/widget/<?php echo $program['gambar']?>"
                            alt="<?php echo $program['judul']?>" /></a>
                </span>
                <?php endforeach; ?>
            </td>
        </tr>
