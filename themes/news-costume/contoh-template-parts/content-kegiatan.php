...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="social-footer">
			<a href="http://www.facebook.com/sharer.php?u=<?= site_url().'kegiatan'.$content['kategori_slug'].'/'. $content['slug']?>" target="_blank"><span><i class="fa fa-facebook"></i></span></a>
			<a href="http://twitter.com/share?url=<?= site_url().'kegiatan'.$content['kategori_slug'].'/'. $content['slug']?>" target="_blank"><span><i class="fa fa-twitter"></i></span></a>
			<a href="https://api.whatsapp.com/send?text=<?= site_url().'kegiatan'.$content['kategori_slug'].'/'. $content['slug']?>" target="_blank"><span><i class="fa fa-whatsapp"></i></span></a>
		</div>
