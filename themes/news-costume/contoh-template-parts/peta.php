					...
					<div class="leaflet-top leaflet-right">
						...
						<div id="target2" class="leaflet-control-layers leaflet-control-layers-expanded leaflet-control hidden" aria-haspopup="true" style="max-height: 315px;">
							...
							<script>
								...
								{
									formAction('mainform', '<?=site_url('maps')?>/layer_keluarga');
								}
								function handle_desa(cb)
								{
									formAction('mainform', '<?=site_url('maps')?>/layer_desa');
								}
								function handle_wil(cb)
								{
									formAction('mainform', '<?=site_url('maps')?>/layer_wilayah');
								}
								function handle_area(cb)
								{
									formAction('mainform', '<?=site_url('maps')?>/layer_area');
								}
								function handle_lokasi(cb)
								{
									formAction('mainform', '<?=site_url('maps')?>/layer_lokasi');
								}
