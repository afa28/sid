      ...
      <div class="halaman-arsip">
        ...
        <div class="col-md-7 col-sm-12">
                    <div class="page-content">                        
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title" style="color:#777">Formulir Kontak</h3>
                            </div>
                            <div class="box-body">
        ...
        <?php } ?>
                                <form action="<?=base_url('kontak/store') ?>" method="post">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input name="nama" type="text" class="form-control" id="InputName" placeholder="Rizky Fajar Prayoga">
                                        </div>
                                        <div class="form-group">
                      <div class="col-md-8">
                        <label for="InputEmail">Email:</label>
                        <input name="email" type="email" class="form-control" id="InputEmail" placeholder="rizky.yoga@gmail.com">
                      </div>
                      <div class="col-md-4">
...
<select name="hal" class="form-control" id="InputSubject" >
...
<?php endforeach ?>
                               ...
                               <div class="form-group col-md-12">
                                            ...
                                            <input name="judul" type="text" class="form-control" id="InputTitle" placeholder="Agenda Bermasalah">
                                        </div>
                                        <div class="form-group col-md-12">
