...
<head>
	...
	<!-- CSS -->
	<link rel="stylesheet" href="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/css/bootstrap.min.css'; ?>">
	<link rel="stylesheet" href="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/css/home.css'; ?>">
	<link rel="stylesheet" href="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/css/loader.css'; ?>">
	<link rel="stylesheet" href="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/font-awesome/css/font-awesome.min.css'; ?>">
</head>
...
<body>
	...
	<video id="bgvid" playsinline autoplay loop muted>
		<source src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/video/komsel.mp4" type="video/mp4'; ?>" />
	</video>
	<section id="wrapper">
		<div class="content">
			<div class="logo">
			...
			<ul class="menu">
				<li>
					<div class="menu-item dropdown">
						...
						<a href="<?= site_url('berita'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/img/icon/berita.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					<div class="menu-item dropdown">
						<a href="<?= site_url('peta'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/img/icon/peta.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					...
					<a href="<?= site_url('agenda'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/img/icon/agenda.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					<div class="menu-item">
						<a href="<?= site_url('program-bantuan'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/img/icon/bantuan-2.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					<div class="menu-item">
						<a href="<?= site_url('laporan-apdes'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/img/icon/apbedes.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					<div class="menu-item">
						<a href="<?= site_url('informasi-publik'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/img/icon/publik.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					...
					<a href="<?= site_url('galery'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/img/icon/galery.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					<div class="menu-item">
						<a href="<?= site_url('data-statistik'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/img/icon/statistik.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					<div class="menu-item">
						<a href="<?= site_url('layanan-mandiri'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/img/icon/layanan-mandiri.png'; ?>" class="img-resonsive">
						</a>
	...
	<!-- JS -->
	<script src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/js/jquery.min.js'; ?>"></script>
	<script src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/js/bootstrap.min.js'; ?>"></script>
	<script src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/portal/js/script.js'; ?>"></script>
</body>
</html>
