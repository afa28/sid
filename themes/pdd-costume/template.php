			...
			<ul class="menu">
				<li>
					<div class="menu-item dropdown">
						...
						<a href="<?= site_url('berita'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/assets/media/icon/berita.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					<div class="menu-item dropdown">
						<a href="<?= site_url('peta'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/assets/media/icon/peta.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					...
					<a href="<?= site_url('agenda'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/assets/media/icon/agenda.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					<div class="menu-item">
						<a href="<?= site_url('program-bantuan'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/assets/media/icon/bantuan-2.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					<div class="menu-item">
						<a href="<?= site_url('laporan-apdes'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/assets/media/icon/apbedes.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					<div class="menu-item">
						<a href="<?= site_url('informasi-publik'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/assets/media/icon/publik.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					...
					<a href="<?= site_url('galery'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/assets/media/icon/galery.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					<div class="menu-item">
						<a href="<?= site_url('data-statistik'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/assets/media/icon/statistik.png'; ?>" class="img-resonsive">
						</a>
				...
				<li>
					<div class="menu-item">
						<a href="<?= site_url('layanan-mandiri'); ?>" class="icon">
							<img src="<?= base_url() . $this->theme_folder . '/' . $this->theme . '/assets/media/icon/layanan-mandiri.png'; ?>" class="img-resonsive">
						</a>
